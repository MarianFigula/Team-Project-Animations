...
if($(".microHDMI").click(function(){
	...
	$(".microHDMI").css({"background-color": "red"});
...
if($(".memory").click(function(){
	...
	$(".memory").css({"background-color": "red"});
...
if($(".procesor").click(function(){
	...
	$(".procesor").css({"background-color": "red"});
...
if($(".blueth").click(function(){
	...
	$(".blueth").css({"background-color": "red"});
...
if($(".usbControll").click(function(){
	...
	$(".usbControll").css({"background-color": "red"});
...
if($(".ethControll").click(function(){
	...
	$(".ethControll").css({"background-color": "red"});
